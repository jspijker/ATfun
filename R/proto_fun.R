# these are function necessary to run this package but are not yet
# part of the package (i.e. not refactored, no manual nor tests).
...
######################################################################
# misc functions for logging and debugging
######################################################################
